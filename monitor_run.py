...
if __name__ == '__main__':
    ...
    yolo_dir = os.path.join(args.root, "yolov5")
    model_dir = os.path.join(args.root, "yolov5/models/yolov5s-all-data.pt")
    sys.path.insert(0, yolo_dir)
    os.chdir(yolo_dir)
    model = torch.hub.load(yolo_dir, 'custom', path=model_dir, source='local', _verbose=False)
